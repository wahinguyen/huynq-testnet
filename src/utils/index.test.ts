...
describe('utils', () => {
  ...
  describe('#isAddress', () => {
    ...
    it('returns the checksummed address', () => {
      expect(isAddress('0xD7ACd2a9FD159E69Bb102A1ca21C9a3e3A5F771B')).toBe('0xD7ACd2a9FD159E69Bb102A1ca21C9a3e3A5F771B')
      expect(isAddress('0xD7ACd2a9FD159E69Bb102A1ca21C9a3e3A5F771B')).toBe('0xD7ACd2a9FD159E69Bb102A1ca21C9a3e3A5F771B')
    })

    it('succeeds even without prefix', () => {
      expect(isAddress('f164fc0ec4e93095b804a4795bbe1e041497b92a')).toBe('0xD7ACd2a9FD159E69Bb102A1ca21C9a3e3A5F771B')
    })
  ...
  describe('#shortenAddress', () => {
    ...
    it('truncates middle characters', () => {
      expect(shortenAddress('0xD7ACd2a9FD159E69Bb102A1ca21C9a3e3A5F771B')).toBe('0xf164...b92a')
    })
